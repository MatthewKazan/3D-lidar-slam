...
class PointCloudSubscriberMixin(GenericHandlerMixin):
    """
    ...
    def __init_pointclouds_subscriber__(self):
        """
    ...
    def setup_input_rosbags(self):
        ...
        """
        input_bag_path = os.path.join(str(os.path.join(PATH_TO_ROSBAGS, 'input_bags')), generate_unique_bag_name(bag_prefix="inputs"))
